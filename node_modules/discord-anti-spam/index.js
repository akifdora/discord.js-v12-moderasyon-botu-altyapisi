...
class AntiSpamClient extends EventEmitter {
	...
	constructor (options) {
		...
		this.options = {
			...
			warnThreshold: options.warnThreshold || 5,
			...
			maxDuplicatesKick: options.maxDuplicatesKick || 7,
			...
			warnMessage: options.warnMessage || '{@user}, spam yapmaya devam edersen mute yiyeceksin!',
			muteMessage: options.muteMessage || '{@user} spam yaptığı için <@&835227731327057973> rolü verildi!',
			...
			banEnabled: options.banEnabled || false,
