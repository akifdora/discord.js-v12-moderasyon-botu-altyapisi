...
exports.run = async (client, message, args) => {
      ...
      if (!uye) return message.channel.send(aiasembed.setDescription("<:antarticaemoji:836010813793239040> • Ses odasına gidilecek üyeyi belirtmelisin!")).then(x => x.delete({timeout: 5000}));
